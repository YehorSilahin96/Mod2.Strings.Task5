...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if (res2) {
            ...
            System.out.println("Illegal. Phone number must contains + and 12 numbers");
            }
        ...
        if (res3) {
            ...
            System.out.println("Illegal. Email address must be in a format: (A-Z,0-9,_.+-)@(A-Z,0-9.-).[A-Z]");
            }
        }
